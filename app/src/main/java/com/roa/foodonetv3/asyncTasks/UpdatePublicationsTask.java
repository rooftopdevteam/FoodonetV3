...
//                    if(!publicationsDBHandler.isUserAdmin(publicationID) ||
//                            publicationsDBHandler.isUserAdmin(publicationID) && publicationsDBHandler.isPublicationOnline(publicationID)){
