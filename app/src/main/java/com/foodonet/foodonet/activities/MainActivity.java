...
import com.foodonet.foodonet.fragments.LatestFragment;
import com.foodonet.foodonet.fragments.ClosestFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,TabLayout.OnTabSelectedListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.map:
                DrawerNavigation.navigationItemSelectedAction(this,R.id.nav_map_view);
                return true;
            case R.id.search:
            default:
...
//                    Toast.makeText(this, getResources().getString(R.string.toast_needs_location_permission), Toast.LENGTH_SHORT).show();
    ...
    //view pager adapter...
    private class ViewHolderAdapter extends FragmentPagerAdapter {

        ViewHolderAdapter(FragmentManager fm) {
            super(fm);
        }
