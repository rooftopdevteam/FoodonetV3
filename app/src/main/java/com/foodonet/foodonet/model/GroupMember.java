...
public class GroupMember implements Parcelable{
    ...
    public int getMemberTypeImage(){
        if(getUserID()== CommonConstants.NON_FOODONET_MEMBER_ID){
           return R.drawable.groups_pending_user;
        } else{
            return R.drawable.groups_user;
        }
    }
