...
public class FoodonetDBProvider extends ContentProvider {
    private static final String AUTHORITY = "com.foodonet.foodonet.db.FoodonetDBProvider";
    ...
    static class RegisteredUsersDB{
        static final String TABLE_NAME = "registered_users";
        static final String _ID_COLUMN = "_id";
        static final String PUBLICATION_ID_COLUMN = "publication_id";
        static final String PUBLICATION_VERSION_COLUMN = "publication_version";
        static final String REGISTERED_USER_ID_COLUMN = "registered_user_id";
        static final String REGISTERED_USER_ACTIVE_DEVICE_UUID_COLUMN = "registered_user_device_uuid";
        static final String REGISTERED_USER_PHONE_COLUMN = "registered_user_phone";
        static final String REGISTERED_USER_NAME_COLUMN = "registered_user_name";
        static final Uri CONTENT_URI = Uri.parse("content://"+AUTHORITY+"/"+TABLE_NAME);
    }

    static class NotificationsDB{
        static final String TABLE_NAME = "notifications";
        static final String _ID_COLUMN = "_id";
        static final String ITEM_ID_COLUMN = "item_id";
        static final String NOTIFICATION_TYPE_COLUMN = "notification_type";
        static final String NOTIFICATION_NAME_COLUMN = "notification_name";
        static final String NOTIFICATION_RECEIVED_TIME_COLUMN = "notification_received_time";
        static final String NOTIFICATION_IMAGE_FILE_NAME_COLUMN = "notification_image_file_name";
        static final Uri CONTENT_URI = Uri.parse("content://"+AUTHORITY+"/"+TABLE_NAME);
    }
